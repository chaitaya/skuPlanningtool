...
function forgotPassword(){
	alert("forgot");
	loadProgress();
	homeBeanForm.action= "forgotPasswordView.htm";
	homeBeanForm.submit();
}
function changePassword(){
	alert("change");
	loadProgress();
	f.action= "changePasswordView.htm";
	f.submit();
}
</script>	
</head>
 ...
 <a class="navbar-brand "  href="#"><img  src="<%=contextPath%>/images/Logo_hp.png" style="max-width:7%;margin-left:10%"/></a>
 		...
 		<div style="background-color:#6B6B6B;padding:7%;padding-left:31%">
							<div class="panel panel-default" style="margin:1px;max-width:60%;border-radius:25px;position:relative;margin-top:8%;box-shadow: 7px 7px 5px #333">
								...
								<span class="glyphicon glyphicon-lock" style="margin-top:2%;text-align:center"></span> Login to Forecasting</div>
								 ...
								 <form class="form-horizontal" name='f' role="form" action="<c:url value='j_spring_security_check' />" method='POST'>
										...
										<div class="col-md-12"  style="margin-top:3%">
											...
											<label for="inputEmail3"   style="color:black;align:center">
												Email</label><br/>
												<input style="width:60%;margin-left:22%" type="text" name="j_username" class="form-control" id="inputEmail3" placeholder="Email" value="admin" required>
										...
										<div class="form-group" style="margin-bottom:5%">
											...
											<label for="inputPassword3"  style="color:black;align:center">
												Password</label><br/>
												<input  style="width:60%;margin-left:22%" type="password" name="j_password" class="form-control" id="inputPassword3" placeholder="Password" value="welcome123" required>
											</div>
										</div>
										<hr/>
