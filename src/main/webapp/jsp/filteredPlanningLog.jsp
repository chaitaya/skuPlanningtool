...
function getPlanningLog(){
	loadProgress();
	planningLogBeanForm.action= "clearPlanningLogUserSession.htm";
	planningLogBeanForm.submit(); 
}
...
<form:form method="post" action="planningLog.htm" 
	...
	<div id="wrapper">
		<div id="page-wrapper" style="  padding-left: 16px; padding-right: 25px; min-height: 500px;">
                        ...
                        <div class="panel panel-default" style="height:520px;width:103%;margin-left:-1.2%" >
							<div class="panel-heading" style="background-color:#2DAFCB;font-size:130%;height:52px;padding:7px 15px;color:#fff;padding-top:1.5%  ">
								...
								<div class="pull-right" style="text-align: right;margin-top:-0.5%">
									<button type="button" style="background:none;border:none;width:40px" onClick="getPlanningLog()"><img src="./images/clearSelection.jpg" title="Clear" style="width: 90%; height: 30%;
							...
							<%if(roles != null && !roles.contains(ApplicationConstants.ADMIN)){ %>
										...
										<div class="margin" style="width:100%;height:406px;overflow-y:auto;padding-top:25px">
							<%}else{ %>
									<div style="height:20px"></div>
									<div class="margin" style="width:100%;height:406px;overflow-y:auto;padding-top:24px">
								<%} %>
